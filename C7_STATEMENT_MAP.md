...
| Publication gate | Lean declaration |
|---|---|
| §7.2 rows/scalars | `ChainInput.qA_exact`, `qB_exact`, `qJ_exact`, `qK_exact` |
| PFIBER | `ChainInput.pfiber_exists` |
| MAX-I | `ChainInput.max_i_exists`, `MaxIFactorization.maximal`, `X_cap`, `Y_cap`, `Z_cap` |
| ROOT0 / ROOT-BOX | `RootSeed.root`, `S_lower`, `C_lower`, `d_pos`, `d_upper` |
| strictness / reversal | `RootSeed.strict`, `reverseChain`, `reversePFiber` |
...
| EA/EB packet caps | `Uj_tau_cap`, `Vj_tau_cap`, `tau_caps` |
| FK-STRONG | `FK_strong` |
